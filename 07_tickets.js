...
client.on('clientReady', async () => {
  console.log(`🟢 07 TICKETS | ONLINE E RESPONDENDO`);
  ...
  try{
    ...
    await voce.send({embeds:[new EmbedBuilder().setColor('#22c55e').setTitle(`🟢 07 TICKETS INICIADO`).setDescription('Todos comandos funcionando ✅')]});
  }catch{}
});
